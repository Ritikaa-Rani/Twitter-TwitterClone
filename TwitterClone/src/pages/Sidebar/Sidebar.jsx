...
Sidebar.propTypes = {
  handlelogout: PropTypes.func, // Validates handlelogout as a required function
  user: PropTypes.shape({
    email: PropTypes.string, // Ensures user has an email string
    photoURL: PropTypes.string, // Validates optional photoURL
    displayName: PropTypes.string, // Validates optional displayName
  }),
};
